...
describe OpenTelemetry::Exporter::GoogleCloudTrace::Translator do
  ...
  it "creates attributes map" do
    ...
    converted_attr = translator.send :create_attributes, attributes, 2, add_agent_attribute: true
  ...
  it "creates span kind" do
    assert_equal translator.send(:create_span_kind, OpenTelemetry::Trace::SpanKind::INTERNAL),
                 Google::Cloud::Trace::V2::Span::SpanKind::INTERNAL
    assert_equal translator.send(:create_span_kind, OpenTelemetry::Trace::SpanKind::CLIENT),
                 Google::Cloud::Trace::V2::Span::SpanKind::CLIENT
    assert_equal translator.send(:create_span_kind, OpenTelemetry::Trace::SpanKind::SERVER),
                 Google::Cloud::Trace::V2::Span::SpanKind::SERVER
    assert_equal translator.send(:create_span_kind, OpenTelemetry::Trace::SpanKind::PRODUCER),
                 Google::Cloud::Trace::V2::Span::SpanKind::PRODUCER
    assert_equal translator.send(:create_span_kind, OpenTelemetry::Trace::SpanKind::CONSUMER),
                 Google::Cloud::Trace::V2::Span::SpanKind::CONSUMER
    assert_equal translator.send(:create_span_kind, "unknown"),
  ...
  def assert_attribute converted_attr, attr_count: 2, dropped_count: 0
    ...
    return unless converted_attr.attribute_map.has_key? :"g.co/agent"
    assert_name converted_attr.attribute_map["g.co/agent"].string_value,
                agent
  end
end
